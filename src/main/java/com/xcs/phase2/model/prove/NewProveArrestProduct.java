...
@Data
public class NewProveArrestProduct extends ProveModel {
    ...
    private int REMAIN_SIZES_UNIT_ID;
    private int REMAIN_QUATITY_UNIT_ID;
    private int REMAIN_VOLUMN_UNIT_ID;
    ...
    private String PRODUCT_DESC_MAS;

    private List<NewProveArrestIndictmentProduct> ProveArrestIndictmentProduct;
    private List<NewProveArrestProductJoin> ProveArrestProductJoin;
