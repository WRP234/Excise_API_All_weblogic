...
import com.xcs.phase2.model.arrest.ArrestModel;
import lombok.Data;

import java.util.List;

@Data
public class NewCompareArrestIndictmentDetail extends ArrestModel {
	...
	private List<NewCompareArrestIndictmentProduct> CompareArrestIndictmentProduct;
