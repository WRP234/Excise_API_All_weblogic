...
@Data
public class AdjustCompare extends AdjustModel {
    ...
    private List<AdjustCompareMapping> AdjustCompareMapping;
    private List<AdjustCompareStaff> AdjustCompareStaff;
