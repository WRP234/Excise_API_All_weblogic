...
import com.xcs.phase2.response.adjust.AdjustCompareStaffResponse;
...
@Service
@Transactional
public class AdjustCompareDetailStaffDAOImpl extends AdjustExt implements AdjustCompareDetailStaffDAO{
    ...
    public AdjustCompareDetailStaffinsAllResponse AdjustCompareDetailStaffinsAll(List<AdjustCompareStaff> req) {
        ...
        AdjustCompareDetailStaffinsAllResponse res = new AdjustCompareDetailStaffinsAllResponse();
        ...
        try {
            ...
            if(req != null) {
                ...
                List<AdjustCompareStaffResponse> list = new ArrayList<AdjustCompareStaffResponse>();
                if(req.size() > 0){

                    for(AdjustCompareStaff item : req){

                        String STAFF_ID = getSequences("SELECT OPS_COMPARE_STAFF_SEQ.NEXTVAL FROM DUAL");
                        AdjustCompareStaffResponse  obj = new AdjustCompareStaffResponse();
                ...
                res.setAdjustCompareStaff(list);
            }
            ...
            res.setAdjustCompareStaff(null);
            return res;
        }
    }

    @Override
    public Boolean AdjustCompareDetailStaffupdByCon(List<AdjustCompareStaff> request) {
        ...
        if(request != null) {
            ...
            if(request.size() > 0){
                ...
                for(AdjustCompareStaff req : request){
    ...
    public Boolean AdjustCompareDetailStaffupdDelete(List<AdjustCompareDetailStaffupdDeleteReq> req) {
        ...
        if(req != null) {
            ...
            if(req.size() > 0){
                ...
                for(AdjustCompareDetailStaffupdDeleteReq item : req){
