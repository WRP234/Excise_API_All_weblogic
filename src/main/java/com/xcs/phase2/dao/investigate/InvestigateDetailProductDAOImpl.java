...
import com.xcs.phase2.response.investigate.InvestigateDetailProductResponse;
...
@Service
@Transactional
public class InvestigateDetailProductDAOImpl extends InvestigateExt implements InvestigateDetailProductDAO {
    ...
    public InvestigateDetailProductinsAllResponse InvestigateDetailProductinsAll(List<InvestigateDetailProduct> req) {
        ...
        InvestigateDetailProductinsAllResponse res = new InvestigateDetailProductinsAllResponse();
        ...
        try {
            ...
            if (req != null) {
                ...
                List<InvestigateDetailProductResponse> list = new ArrayList<InvestigateDetailProductResponse>();
                if (req.size() > 0) {

                    for (InvestigateDetailProduct item : req) {

                        String PRODUCT_ID = getSequences("SELECT OPS_INVESTI_DETAIL_PRODUCT_SEQ.NEXTVAL FROM DUAL");
                        InvestigateDetailProductResponse obj = new InvestigateDetailProductResponse();
                        obj.setPRODUCT_ID(Integer.parseInt(PRODUCT_ID));

                        StringBuilder sqlBuilderSub = new StringBuilder()
                                .append("Insert into OPS_INVESTIGATE_DETAIL_PRODUCT ( " +
                                        "PRODUCT_ID," +
                ...
                res.setInvestigateDetailProduct(list);
            }
            ...
            res.setInvestigateDetailProduct(null);
            return res;
        }
    }

    @Override
    public Boolean InvestigateDetailProductupdByCon(List<InvestigateDetailProduct> request) {
        ...
        if (request != null) {
            ...
            if (request.size() > 0) {
                ...
                for (InvestigateDetailProduct req : request) {

                    StringBuilder sqlBuilderSub = new StringBuilder()
                            .append("UPDATE OPS_INVESTIGATE_DETAIL_PRODUCT "
                                    + "SET "
    ...
    public Boolean InvestigateDetailProductupdDelete(List<InvestigateDetailProductupdDeleteReq> req) {
        ...
        if(req != null) {
            ...
            if(req.size() > 0){
                ...
                for(InvestigateDetailProductupdDeleteReq item : req){

                    StringBuilder sqlBuilder = new StringBuilder().append("UPDATE OPS_INVESTIGATE_DETAIL_PRODUCT SET IS_ACTIVE = '0' WHERE PRODUCT_ID = '"+item.getPRODUCT_ID()+"' ");
