...
@Service
@Transactional
public class InvestigateDetailStaffDAOImpl extends InvestigateExt implements InvestigateDetailStaffDAO {

    private static final Logger log = LoggerFactory.getLogger(InvestigateDetailStaffDAOImpl.class);


    @Override
    public InvestigateDetailStaffinsAllResponse InvestigateDetailStaffinsAll(List<InvestigateDetailStaff> req) {

        InvestigateDetailStaffinsAllResponse res = new InvestigateDetailStaffinsAllResponse();
        ...
        try {
            ...
            if (req != null) {
                ...
                if (req.size() > 0) {
                    ...
                    for (InvestigateDetailStaff item : req) {
    ...
    @Override
    public Boolean InvestigateDetailStaffupdByCon(List<InvestigateDetailStaff> request) {
        ...
        if (request != null) {
            ...
            if (request.size() > 0) {
                ...
                for (InvestigateDetailStaff req : request) {

                    StringBuilder sqlBuilder = new StringBuilder()
                            .append("UPDATE OPS_INVESTIGATE_DETAIL_STAFF SET "
    ...
    public Boolean InvestigateDetailStaffupdDelete(List<InvestigateDetailStaffupdDeleteReq> req) {
        ...
        if (req != null) {
            ...
            if (req.size() > 0) {
                ...
                for (InvestigateDetailStaffupdDeleteReq item : req) {

                    StringBuilder sqlBuilder = new StringBuilder().append("UPDATE OPS_INVESTIGATE_DETAIL_STAFF SET IS_ACTIVE = '0' WHERE STAFF_ID = '" + item.getSTAFF_ID() + "' ");
